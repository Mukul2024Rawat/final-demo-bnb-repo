  ...
  return (
    <div className="h-[100%]">
      <MapContainer
        {...mapProps}
        center={[
          parseFloat(locationValue.lat) ||  29.9384473,
          parseFloat(locationValue.lon) ||  78.1452985,
        ]}
      >
        <TileLayer
        ...
        />
        <SetMapCenter
          lat={parseFloat(locationValue.lat) || 29.9384473}
          lon={parseFloat(locationValue.lon) || 78.1452985}
        />
