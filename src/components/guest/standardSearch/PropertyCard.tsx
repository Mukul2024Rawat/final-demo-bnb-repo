...
const HotelCard = ({
  ...
  return (
    <div
      className="bg-white rounded-xl overflow-hidden mb-4 cursor-pointer flex flex-col md:flex-row hover:bg-slate-100 p-2"
      onClick={handleHotelClick}
    >
      <div className="relative w-full md:w-1/3 rounded-xl mb-2 md:mb-0 h-[70%]">
        <Image
          src={imageUrl || "/start.jpeg"}
          alt={name}
          className="w-full h-[70%] object-cover rounded-xl md:h-full"
          width={300}
          height={200}
        />
      </div>
